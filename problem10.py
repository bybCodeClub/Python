...
# rewrite the grade program from problem 8 putting all this code into a function.
...
def grades_converter(grades):
    if grades >= 90:
        ...
        print("D \nwow you passed, looks like your not a complete retard,")
    elif grades < 50:
        print("F+ \nWell Mcdonalds and Wal-mart are always hiring, you might as well apply because your wasting you time here.")
